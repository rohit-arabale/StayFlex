        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            <Link to="/home" className="flex-shrink-0">
              <h1 className="text-2xl font-bold text-transparent bg-clip-text bg-proj lg:text-3xl">StayFlex</h1>
              <p className="text-xs font-medium text-gray-500">by Rohit Arabale</p>
            </Link>
          </div>
