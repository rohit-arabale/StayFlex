...
function FAQ() {
   ...
   const faqs = [
    {
        question: 'What is StayFlex?',
        answer: 'StayFlex is India\'s hospitality company, offering hourly stays and flexible check-in and check-out times. We provide standardized rooms across various locations in India.'
    },
    {
        question: 'How is StayFlex different from an online marketplace of hotel rooms?',
        answer: 'StayFlex guarantees a consistent experience across all its hotels, unlike online marketplaces where user experiences can vary. Customers can book rooms for a minimum of 4 hours and check in at any time.'
    },
    {
    ...
    {
        question: 'What are the key features of "standardized" StayFlex?',
    ...
    {
        question: 'How much does a StayFlex room cost? Are there any hidden charges?',
    ...
    {
        question: 'How can one book a StayFlex room?',
        answer: 'You can book through the StayFlex app, website (www.StayFlex.co), by calling +91-9000000000, or via WhatsApp at +91-8000000000. Partner online travel agents may not offer short-duration bookings.'
    },
    {
    ...
    },
    {
        ...
        answer: 'Yes, StayFlex offers rooms for day use. You can book a room for as little as 4 hours, which is perfect for short stays or day use.'
    }
];
